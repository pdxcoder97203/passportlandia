...
router.get('/stamps/:id/comments/:comment_id/edit', checkCommentOwnership, (req, res) => {
...
router.put('/stamps/:id/comments/:comment_id', checkCommentOwnership, (req, res) => {
...
// Delete a comment
router.delete('/stamps/:id/comments/:comment_id', checkCommentOwnership, (req, res) => {
